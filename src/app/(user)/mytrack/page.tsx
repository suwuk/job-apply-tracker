...
export default function MyTrackMainPage() {
  ...
  return (
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 px-1">
      <div>
        <h2 className="text-2xl md:text-3xl font-black text-gray-800 tracking-tight">Application Board</h2>
        <p className="text-gray-400 text-[10px] md:text-xs font-bold uppercase tracking-[0.2em]">Track your career journey</p>
      </div>

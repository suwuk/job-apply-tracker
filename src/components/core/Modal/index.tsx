...
export default function Modal({ children, isOpen, onClose, maxWidth = "max-w-4xl" }: any) {
    ...
    return (
        ...
        >
            <div className={`relative w-full ${maxWidth} mx-auto animate-in fade-in zoom-in duration-200`}>
                {children}
            </div>
        </div>
    );
